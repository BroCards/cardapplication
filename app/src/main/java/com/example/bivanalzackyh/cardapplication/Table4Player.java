...
public class Table4Player extends Table {
    ...
    draws the card, it will first go here. After all 4 players play their card,
    the score will be calculated and then all those 4 cards will be going to
    the discard pile
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_table4_player);
        ...
        viewPlay4 = (View) findViewById(R.id.viewPlay4);
